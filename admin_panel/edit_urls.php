        ...
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-static-top" role="navigation">
                <div class="navbar-header">
                    ...
                    <h1> <a class="navbar-brand" href="index.php">Minimal</a></h1>         
                </div>
                    ...
                    <div class="grid-form">
                        <div class="grid-form1">
                            ...
                            <form enctype="multipart/form-data" method="post" action="../controller/_fileupload.php">
                                ...
                                <input type="hidden" name="page" value="controlpanel/forms.php"/>
                                <input type="hidden" name="debug" value="controlpanel/forms.php"/>
                                        ...
                                        foreach ($urls as $u) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="../controller/_delete.php?model=heatwebsite&id=<?= $u['domain_name'] ?>&page=forms.php"> <i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
